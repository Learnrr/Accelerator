...
## Examples
`examples` directory has 2 picture files in 'jpg' and 'coe'. 'plane.coe' and 'car.coe' are generated by Pytorch. You can make a initialization of 'bram0' using these files. all picture coes are generated in channel-major form.
