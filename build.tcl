...
#
# build.tcl: Tcl script for creating project 'project'
#
...
set_property -name "webtalk.xsim_launch_sim" -value "947" -objects $obj
...
set files [list \
 ...
 [file normalize "${origin_dir}/srcs/sources_1/new/adder_32bit.v" ]\
